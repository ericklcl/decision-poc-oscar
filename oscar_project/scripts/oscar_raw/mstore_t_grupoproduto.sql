...
WITH raw_data AS (
    ...
    FROM {{ source('oscar_raw_json', 'jsn_mstore_t_grupoproduto') }}
)
...
SELECT
    ...
    JSON_DATA:idgrupoprodutoecommerce::NUMBER AS idgrupoprodutoecommerce,
    JSON_DATA:codigoab::NUMBER AS codigoab,
    JSON_DATA:imprimirpreco::VARCHAR AS imprimirpreco,
